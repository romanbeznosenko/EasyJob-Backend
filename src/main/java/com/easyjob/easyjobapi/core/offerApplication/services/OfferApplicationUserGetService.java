...
public class OfferApplicationUserGetService {
    ...
    public OfferApplicationPageResponse getUserApplication(int page, int limit){
        log.info("Getting user applications");
        ...
        Specification<OfferApplicationDAO> spec = OfferApplicationSpecifications.findByUserId(userDAO.getId());

        Page<OfferApplicationDAO> offerApplicationDAOS = offerApplicationManager.findAll(spec, pageable);
