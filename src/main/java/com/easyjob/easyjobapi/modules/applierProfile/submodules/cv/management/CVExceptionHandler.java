...
public class CVExceptionHandler {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "404", description = "CV not found in the system.",
                    content = @Content(
                            examples = @ExampleObject(value = """
                                      {
                                      "data": null,
                                      "message": "CV not found in the system.",
    ...
    public ResponseEntity<CustomResponse<String>> handleCVNotFoundException(CVNotFoundException ex) {
